      ...
      <div class="dashboard_item dashboard_item-${id}">
        <article class="tracking-card">
          <header class="tracking-card_header">
            ...
            <img src="images/icon-ellipsis.svg" alt="" class="tracking-card_menu">
          </header>
          <div class="tracking-card_body">
            <div class="tracking-card_time">
              ${current}hrs
            </div>
            <div class="tracking-card_period">
        ...
        this.prev = this.container.querySelector(`.dashboard_item-${id} .tracking-card_period`);
    }
